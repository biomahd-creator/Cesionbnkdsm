import svgPaths from "./svg-x4u6qzxyqr";
    ...
    <div className="relative size-full" data-name="Capa_1">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 477 91">
        <g clipPath="url(#clip0_31_179)" id="Capa_1">
          ...
          <path d={svgPaths.pe6fa140} fill="white" id="Vector_10" />
          <path d={svgPaths.p38eac900} fill="white" id="Vector_11" />
          <g id="Group">
            <path d={svgPaths.pd7ab00} fill="white" id="Vector_12" />
            <path d={svgPaths.p307ff400} fill="white" id="Vector_13" />
          </g>
        </g>
        <defs>
