          ...
          <div className="flex flex-col gap-3 md:flex-row md:items-center justify-between">
            ...
            <div className="flex items-center gap-2 overflow-x-auto pb-2 md:pb-0 hide-scrollbar">
              <Button
                variant="outline"
                size="sm"
                className="h-9 border-dashed px-3 text-muted-foreground bg-background hover:text-foreground"
              >
                  ...
                  {columns.map((col) => {
                    ...
                    if (key === "observations") return (
                        <TableCell key={key} className="text-sm text-foreground">
                            ...
                            <a href="#" onClick={(e: React.MouseEvent) => e.preventDefault()} className="text-info underline hover:text-info">
                                mas
                            </a>
                        </TableCell>
                    );
