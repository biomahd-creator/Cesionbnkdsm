/**
 * FactoringKpiCard — Color-accent KPI card with bottom border
 *
 * Features:
 * - 7 color variants (blue, yellow, green, orange, darkgray, purple, lime)
 * - Active/hover state with color transition
 * - Badge counter (top-right corner)
 * - Elevation shadow system (shadow-elevation-1 → shadow-elevation-4)
 * - Icon slot (trailing, bottom-right)
 *
 * @layer widgets
 */
...
export interface FactoringKpiCardProps {
  label: string;
  description: string;
  value: string;
  count: number;
