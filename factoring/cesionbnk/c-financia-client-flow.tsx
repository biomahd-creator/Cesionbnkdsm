        ...
        <div className="min-h-screen p-8 pb-32 pt-[90px]">
            ...
            <CardContent className="p-6 flex items-center justify-between">
              <div className="flex items-center gap-4">
                <Avatar className="h-16 w-16">
                  ...
                  <AvatarFallback className="bg-muted text-primary">EV</AvatarFallback>
                </Avatar>
                <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <Card>
              <CardHeader className="px-6 pt-5 pb-3 flex flex-row items-center justify-between">
                ...
                <button className="text-[10px] text-primary hover:text-primary transition-colors">Agregar Cuenta</button>
              </CardHeader>
              <CardContent className="p-6 pt-0 space-y-4">
                <div className="space-y-1">
                ...
                <div className="flex items-center justify-between p-3 rounded-[var(--radius)] bg-muted border border-border">
                  <span className="text-xs font-medium text-muted-foreground">¿Asegurada?</span>
                  <div className="flex gap-1">
                    <button className={cn("h-7 px-3 rounded-md text-[10px] font-medium transition-all duration-200", isInsured ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground border border-border hover:bg-accent")} onClick={() => setIsInsured(true)}>Sí</button>
                    <button className={cn("h-7 px-3 rounded-md text-[10px] font-medium transition-all duration-200", !isInsured ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground border border-border hover:bg-accent")} onClick={() => setIsInsured(false)}>No</button>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-4">
            ...
            {mockClientsData.map((client) => {
              ...
              return (
                <Card key={client.id} className="overflow-hidden transition-all duration-300 hover:border-primary">
                  <div
                    className={cn("p-5 flex items-center justify-between cursor-pointer hover:bg-muted transition-colors", isExpanded && "bg-muted")}
                    onClick={() => toggleClient(client.id)}
                  >
                    <div className="flex items-center gap-4">
                      <div className="w-10 h-10 rounded-full bg-muted flex items-center justify-center text-primary font-bold">{client.name[0]}</div>
                  ...
                  {isExpanded && (
                    <div className="p-4 border-t border-border bg-muted animate-in slide-in-from-top-2 duration-300">
