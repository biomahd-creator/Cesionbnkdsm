              ...
              <div className="flex gap-3 rounded-xl border border-border bg-muted p-4">
                ...
                <div className="space-y-1">
                  ...
                  <div className="text-xs text-muted-foreground">
                    ...
                    <p className="font-bold text-muted-foreground">Formatos admitidos: ZIP, XML y Excel</p>
                  </div>
                </div>
              </div>

              {/* Upload Area */}
              <div className="group flex cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-border py-12 text-center transition-all duration-300 hover:bg-muted hover:border-primary">
                <div className="mb-4 rounded-full border border-border bg-muted p-4 transition-all duration-300 group-hover:border-primary group-hover:bg-muted group-hover:shadow-sm">
