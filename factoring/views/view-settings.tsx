        ...
        <div className="flex items-center gap-4">
          <div className="relative">
            <Avatar className="size-16 border-2 border-primary">
              <AvatarFallback className="bg-muted text-primary text-xl">SP</AvatarFallback>
            </Avatar>
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        ...
        <div>
          ...
          <div className="flex items-start justify-between gap-4 rounded-lg border bg-muted p-4">
        ...
        <div>
          ...
          <div className="space-y-3">
            {sessions.map((s) => (
              <div key={s.device} className="flex items-center gap-3 rounded-lg border p-3">
                ...
                {!s.active && (
                  <Button variant="ghost" size="sm" className="h-7 text-xs text-red-500 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-950 shrink-0">
          ...
          <div className="flex justify-end mt-3">
            <Button variant="outline" size="sm" className="h-8 text-xs text-red-500 border-red-200 hover:bg-red-50 dark:hover:bg-red-950">
