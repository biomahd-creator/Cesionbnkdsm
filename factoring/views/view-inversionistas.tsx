...
function FundRow({ inv, color, index }: {
  ...
  return (
    <>
      <TableRow className="cursor-pointer hover:bg-muted transition-colors" onClick={() => setOpen(!open)}>
