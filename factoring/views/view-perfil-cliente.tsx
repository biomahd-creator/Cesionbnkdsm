      ...
      <main className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        ...
        <Card><CardContent className="p-6"><div className="flex flex-col md:flex-row gap-6">
          <div className="flex items-start gap-4">
            <div className="size-14 rounded-xl bg-muted flex items-center justify-center shrink-0"><Building2 className="size-7 text-primary" /></div>
            <div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card><CardHeader className="pb-2"><CardTitle>Concentración de Deudores</CardTitle><CardDescription>Por monto operativo</CardDescription></CardHeader><CardContent>
            ...
            {cliente.deudores[0]?.pct > 40 && (<div className="mt-3 flex items-start gap-2 rounded-md bg-yellow-50 dark:bg-yellow-950 border border-yellow-200 dark:border-yellow-800 p-2.5"><AlertTriangle className="size-3.5 text-yellow-600 shrink-0 mt-0.5" /><p className="text-xs text-yellow-700 dark:text-yellow-400">Alta concentración en {cliente.deudores[0].nombre} ({cliente.deudores[0].pct}%)</p></div>)}
          </CardContent></Card>
        </div>
        ...
        <Card><CardHeader className="pb-3"><CardTitle>Resumen de Riesgo</CardTitle></CardHeader><CardContent><div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div key={item.label} className={`flex items-center gap-3 rounded-lg border p-4 ${item.ok ? "border-border" : "border-yellow-300 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-950"}`}>
